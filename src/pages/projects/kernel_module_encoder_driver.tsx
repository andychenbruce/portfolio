...
function KernelmoduleEncoderDriver(props) {
  ...
  return (
    <Wrapper head={new_heads} {...props}>
	  ...
	  <img src="i05-Uxcell-Motor.jpg" width="465" height="349" /><div className="imageCaption" style={{width: "465px"}}>Uxcell gear motor with encoder
	</div></div>
	...
	<p>A <a href="https://en.wikipedia.org/wiki/Rotary_encoder">rotary encoder</a> is an electro-mechanical device that senses rotation of a motor shaft and converts it into a digital signal that can be processed by a computer.
      ...
      <div className="imageContainer floatLeft">
	  <img src="i05-Encoder-Wires.jpg" width="423" height="362" /><div className="imageCaption" style={{width: "423px"}}>Encoder on the end of the motor shaft
	</div></div>
	...
	<hr className="clearLeft" />
      ...
      <div className="imageContainer floatLeft">
	  <img src="i05-Incremental_directional_encoder.gif" width="258" height="150" /><div className="imageCaption" style={{width: "258px"}}>Incremental directional encoder
	</div></div>

      <div className="imageContainer floatLeft">
	  <img src="i05-EncoderSignals.png" width="300" height="249" /><div className="imageCaption" style={{width:"300px"}}>Encoder signals
	</div></div>

	<div className="imageContainer floatLeft">
	  <img src="i05-EncoderFwdBwd.jpg" width="255" height="250" /><div className="imageCaption" style={{width:"255 px"}}>Forward and backwards rotations
	</div></div>
	...
	<p>
      ...
      <AndyCodeBlock source_path="static/projects/kernel_module_encoder_driver/encoderDriver.c" language="c" />
      <hr className="clearLeft" />
      <p>This is the user program for reading the encoder counts.</p>
      <AndyCodeBlock source_path="static/projects/kernel_module_encoder_driver/encoderTestMmap.c" language="c" />
      <hr className="clearLeft" />
      <p>This is the Makefile for compiling the source code listed above.</p>
      <AndyCodeBlock source_path="static/projects/kernel_module_encoder_driver/encoder.makefile" language="makefile" />
      <hr className="clearLeft" />
      <p>This is a Python script for the GUI to display the encoder counts in the video.</p>
      <AndyCodeBlock source_path="static/projects/kernel_module_encoder_driver/gui.py" language="python" />
      <hr className="clearLeft" />
	
      <div className="imageContainer floatLeft">
	  <video className="floatLeft" width="640" controls><source src="Encoder-480.mp4" type="video/mp4" />Your browser does not support the video tab.
	  </video>
	  <div className="imageCaption" style={{width: "640px"}}>Testing the encoder driver.
	</div></div>
