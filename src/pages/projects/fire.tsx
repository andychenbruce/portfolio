...
function Fire(props) {
  ...
  original tranformation matrix. The code is listed below.</p>
      <AndyCodeBlock source_path="static/projects/fire/drawBillboard.cpp" language="cpp" />
      
      <hr className="clearLeft"/>
      <p>Here is the rest of the code to draw the flame.</p>
      <AndyCodeBlock source_path="static/projects/fire/main.cpp" language="cpp" />
      
      <hr className="clearLeft"/>
      <p>Here is the fragment shader that runs on the GPU.</p>
      <AndyCodeBlock source_path="static/projects/fire/shader.frag" language="c" />
