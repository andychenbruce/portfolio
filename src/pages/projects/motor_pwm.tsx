...
function MotorPWM(props) {
  ...
  return (
    <Wrapper head={new_heads} {...props}>
	  ...
	  <img src="L298-H-Bridge.jpg" width="353" height="393" /><div className="imageCaption" style={{width:"353 px"}}>L298 H-Bridge
								  </div></div>
  ...
  are connected to an <a href="https://en.wikipedia.org/wiki/H-bridge">H-Bridge</a> to control a stronger current.  Motors need much more power than LEDs.</p>
      ...
      <div className="imageContainer floatLeft">
	  <img src="L298-Labels.jpg" width="500" height="333" /><div className="imageCaption" style={{width:"500 px"}}>L298 with I/O Labels
								</div></div>
	
      <hr className="clearLeft" />

      <div className="imageContainer floatLeft">
	  <img src="L298-Schematic.png" width="437" height="433" /><div className="imageCaption" style={{width:"437 px"}}>L298 to RPi interface
								   </div></div>
      ...
      <div className="imageContainer floatLeft">
	  <img src="Buck-Converter.jpg" width="210" height="223" /><div className="imageCaption" style={{width:"210 px"}}>12v to 5v Buck Converter
								   </div></div>
  ...
  All I needed was a USB-A to USB-C cable.
      ...
      <div className="imageContainer floatLeft">
	  <video className="floatLeft" width="640" controls><source src="wiringControlBoard-720.mp4" type="video/mp4" />Your browser does not support the video tab.
	  </video>
	  <div className="imageCaption" style={{width:"640px"}}>Wiring the control board. My arms were sunburned  when I made this video.
</div></div>
      <p>
  This is a video of the assembly and wiring of the robot control board. The Raspberry Pi is the green board in the lower right.  The L298 H-Bridges are at the top of the board.  The metal angle holds a small USB fan used to keep the Raspberry Pi cool during intensive computer vision processing.
      ...
      <div className="imageContainer floatLeft">
	  <video className="floatLeft" width="640" controls><source src="motorPwm-480.mp4" type="video/mp4" />Your browser does not support the video tab.
	  </video>
	  <div className="imageCaption" style={{width: "640px"}}>640
</div></div>
      ...
      <div className="imageContainer floatLeft">
	  <img src="burnt-wires.jpg" width="564" height="772" /><div className="imageCaption" style={{width: "564 px"}}>Burnt wires from an accidental short.
								</div></div>
