...
function SeedlingTensorflor(props) {
  ...
  the code is easy and is just:
      ...
      <AndyCodeBlock source_path="static/projects/seedlings_tensorflow/keras_simple.py" language="python" />
  ...
  The twelve <a href="https://en.wikipedia.org/wiki/Softmax_function">softmax</a> outputs represent the probability of each seedling classification and sum to 1.0.
	...
	<br/>
      ...
      <AndyCodeBlock source_path="static/projects/seedlings_tensorflow/data_generator.py" language="python" />
