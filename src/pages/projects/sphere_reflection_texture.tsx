...
function Boltzman(props) {
  ...
  let new_head = (<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/11.2.0/styles/default.min.css" />);
  ...
  return (
	...
	and the fragment shader code I wrote in GLSL.</p>
      ...
      <hr className="clearLeft" />
      <AndyCodeBlock source_path="static/projects/sphere_reflection_texture/shader.vert" language="c" />
      
	    
	
      <hr className="clearLeft" />
      <AndyCodeBlock source_path="static/projects/sphere_reflection_texture/shader.frag" language="c" />
