...
function DeltaGcode(props) {
  ...
  return (
    <Wrapper head={new_heads} {...props}>
	  ...
	  <img src="Delta-X.jpg" width="487" height="479" /><div className="imageCaption" style={{width: "487px"}}>Delta-X Robot
							    </div></div>
	...
	When it arrived, I connect it to the bottom of the robot frame.
      ...
      <div className="imageContainer floatLeft">
	  <img src="DeltaAnimation.gif" width="437" height="367" /><div className="imageCaption" style={{width: "437 px"}}>Delta robot kinematics, © Wikimedia
								   </div></div>
      <p>Delta robot kinematics (green arms are fixed length, at 90° to the blue axis that they rotate about)</p>
      <hr className="clearLeft" />
      <div className="imageContainer floatLeft">
	  <video className="floatLeft" width="640" controls><source src="Delta-G-Code-720.mp4" type="video/mp4" />Your browser does not support the video tab.
	  </video>
	  <div className="imageCaption" style={{width: "640px"}}>Testing the delta robot arm with G-code
</div></div>
