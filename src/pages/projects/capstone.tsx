...
function Capstone(props) {
  return (
    <Wrapper {...props}>
      ...
      <p>
        Every year, 24 billion tonnes of topsoil are lost to erosion, farms emit
        four billion tonnes of CO2 from fossil fuels, and two million tonnes of
        herbicides and pesticides leech into our environment. Agriculture
        consumes 90% of our freshwater. A third of humanity toils on farms, an
        enormous waste of human potential.
      </p>

      <p>
        These problems can all be reduced with agricultural robotics and
        artificial intelligence. Robots enable no-till farming without plowing.
        Precise application of herbicides and pesticides can reduce the use of
        agricultural chemicals by 95%. Direct injection irrigation uses 90% less
        water than flood irrigation while reducing fertilizer consumption.
        Polyculture can replace monoculture to increase yields.
      </p>
      ...
      <p>
        ...
        fertilizer directly into the root zone of individual crop plants,
        reducing the need for fertilizer by 90% while eliminating runoff and
      ...
      <p>
        My robot has some limitations. It can only operate in good weather. It
        has limited battery capacity, which could be improved with solar power.
        Lights attached to the vision system would allow the robot to operate
        24/7.
      </p>

      <p>
        The application of robotics, computer vision, and artificial
        intelligence to sustainable agriculture is a fascinating subject and is
        an area where I believe I can make a significant contribution.
      </p>
