...
function Capstone(props) {
  ...
  return (
    <Wrapper {...props}>
	  ...
	  <video className="floatLeft" width="640" controls><source src="Farmbot-ParkingLot-001-720.mp4" type="video/mp4" /> Your browser does not support the video tab. </video>
	  <div className="imageCaption" style={{width: "640px"}}>FarmBot controlled with a cell phone.
</div></div>
  ...
  For my senior Capstone project, I have designed, built, and programmed an agricultural robot for
      ...
      <p>
	  <div className="imageContainer floatLeft">
	    <img src="hydrogel.jpg" width="427" height="240" /><div className="imageCaption" style={{width: "427px"}}>Hydrogel gives water and nutrients to crops but not weeds
	  </div></div>
  ...
  which requires heavy use of herbicides. Using robotics for the precise application of herbicides can reduce the use of these problematic chemicals. Organic alternatives can be used since a robot can distinguish crops from weeds and only spray the weeds.
      ...
      <p>
	  <div className="imageContainer floatLeft">
	    <img src="mono-vs-poly.jpg" width="417" height="250" /><div className="imageCaption" style={{width: "417 px"}}>Monoculture vs polyculture
	  </div></div>
  ...
  Conventional mechanized farming depends on monoculture, increasing the risk of diseases and insect infestation. Robotics and AI allow polyculture. Different crops can be planted together, or the plantings can be staggered so that one crop can sprout and grow in the shade of a more mature crop for an additional harvest each year.
      ...
      <p>
	  <div className="imageContainer floatLeft">
	    <img src="RaspberryPi-4B.jpg" width="500" height="322" /><div className="imageCaption" style={{width: "500px"}}>Raspberry Pi 4B
	  </div></div>
