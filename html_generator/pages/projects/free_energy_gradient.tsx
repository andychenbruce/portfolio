...
` }/>
	...
	<div className="mathSubDiv">
	  ...
	  <p>
	       Now if we assume that <MakeMath tex={"\\mathbf{J}_\\mathcal{f}(\\vec{r})\\mathbf{J}_\\mathcal{f}^\\top(\\vec{r})"} /> is invertable, which it is if the rows of <MakeMath tex={"\\mathbf{J}_\\mathcal{f}(\\vec{r}"} /> are linearely independent (this assumption implies <MakeMath tex={"m \\le 3N"} /> must be true placing additional constraints on the choice of coarse grain-ing function), then we can multiply both sides by its inverse.
	  </p>
